...
export class AttendentData {
	...
	getTimeInOut(username: string) {
		return this.http.get('http://192.168.10.130:3030/getTimeInOut?username=' + username).map(res => res.json());
	}

	getAbsenRecord(username: string) {
		return this.http.get('http://192.168.10.130:3030/checkAbsenRecord?username=' + username).map(res => res.json());
	}
	...
	insertAbsen(username: string) {
		return this.http.get('http://192.168.10.130:3030/InsertAbsenPegawai?username=' + username).map(res => res.json());
	}
